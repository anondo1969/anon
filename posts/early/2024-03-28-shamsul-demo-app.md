---
title: PhD-work - SHAMSUL Demo App
date: 2024-03-28
lang: en
type: PhD blog page
tags: [PhD research]
excerpt: "SHAMSUL Demo App: https://shamsul.serve.scilifelab.se/ SHAMSUL SHAMSUL explores interpretability for chest X-ray pathology predictions using methods—Grad-CAM, LIME, SHAP, and LRP. It provides heatmaps and evaluation metrics for better insights into the..."
---

# PhD-work - SHAMSUL Demo App
...
2c. Open your browser and go to [http://localhost:7860/](http://localhost:7860/) to use the app.
